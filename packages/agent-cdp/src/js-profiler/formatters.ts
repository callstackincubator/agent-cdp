...
export function formatJsProfileStatus(result: JsProfileStatusResult): string {
  const lines: string[] = [];
...
export function formatJsSessionList(entries: JsSessionListEntry[]): string {
...
export function formatJsProfileSummary(summary: JsProfileSummary): string {
  const lines: string[] = [];
...
export function formatJsHotspots(result: JsHotspotsResult): string {
  const lines: string[] = [];
...
export function formatJsHotspotDetail(result: JsHotspotDetailResult): string {
  const lines: string[] = [];
...
export function formatJsModules(result: JsModulesResult): string {
  const lines: string[] = [];
...
export function formatJsStacks(result: JsStacksResult): string {
  const lines: string[] = [];
...
export function formatJsSlice(result: JsSliceResult): string {
  const lines: string[] = [];
...
export function formatJsDiff(result: JsDiffResult): string {
  const lines: string[] = [];
